...
export default function CTA() {
  return (
    <section className="py-20 bg-gradient-to-br from-navy to-blue text-center relative overflow-hidden">
      {/* Decorative compass */}
      <div
      ...
      <div className="max-w-7xl mx-auto px-5 relative z-10">
        <motion.h2
          ...
          className="font-heading text-3xl lg:text-5xl font-bold text-white mb-5"
        >
        ...
        <motion.p
          ...
          className="text-white/75 text-lg max-w-xl mx-auto mb-9"
        >
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.97 }}
          className="inline-flex items-center gap-2.5 bg-gradient-to-br from-gold to-gold-light text-navy px-10 py-4 rounded-full font-bold shadow-lg shadow-gold/40 transition-shadow hover:shadow-xl hover:shadow-gold/50 group relative overflow-hidden"
        >
