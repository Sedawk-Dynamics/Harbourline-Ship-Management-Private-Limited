...
export default function Services() {
  return (
    <section
      id="services"
      className="py-14 sm:py-20 lg:py-24 bg-off-white relative"
      style={{
    ...
    >
      <div className="max-w-7xl mx-auto px-5">
        ...
        <motion.div
          ...
          className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-7 relative z-10"
        >
          {services.map((s, i) => (
            <motion.div
              key={s.title}
              ...
              className="service-card bg-white rounded-2xl p-6 sm:p-8 lg:p-10 relative overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-400 group cursor-pointer"
            >
              {/* Top gradient bar */}
